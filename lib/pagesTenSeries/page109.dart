                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Container(
                          ...
                          child: Text('Insurance',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24.0),),
                      ),
                    ),
                  ],
                ),
                        ...
                        children: <Widget>[
                          Expanded(
                            child: Column(
                              ...
                              children: <Widget>[
                                Text('Insurance',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18.0,color: Colors.black),),
                                Text('- \$2 million in liability insurance'),
                                Text('- \$500 max out of pocket for vehicla damage or theft'),
                              ],
                            ),
                          ),
                          Center(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: <Widget>[
                            Text('Minimum',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18.0,color: Colors.black),),
                            Text('- \$2 million in liability insurance'),
                            Text('- \$3,000max out of pocket for vehicla damage or theft'),
                          ],
                        ),
                      ),
                    ],
