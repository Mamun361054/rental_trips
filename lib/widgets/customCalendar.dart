...
class _CustomCalendarViewState extends State<CustomCalendarView> {
        ...
        Expanded(
          child: Center(
            child: Text(
              ...
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.deepOrangeAccent,),
            ),
          ),
        ),
      );
  ...
  ///calendar day ui design
  ///if current day then highlighted day will show
  ///this method actually got many logic to represent the calendar
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date) ? Colors.deepOrangeAccent : Colors.transparent,
                              borderRadius: BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: DateTime.now().day == date.day && DateTime.now().month == date.month && DateTime.now().year == date.year
                                ? getIsInRange(date) ? Colors.white :Colors.orange
                                : Colors.transparent,
